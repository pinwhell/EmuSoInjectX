...
HD-Adb -s emulator-5554 shell "su -c 'rm data/local/tmp/%moduleName64%'"
HD-Adb -s emulator-5554 push libs/arm64-v8a/%moduleName% data/local/tmp/%moduleName64%
HD-Adb -s emulator-5554 shell "su -c 'chmod 7777 data/local/tmp/%moduleName64%'"
HD-Adb -s emulator-5554 shell "su -c 'chown 0 data/local/tmp/%moduleName64%'"
HD-Adb -s emulator-5554 shell "su -c 'chgrp 0 data/local/tmp/%moduleName64%'"
